---
title: "Analyzing Job Market Data with LLMs in Sheets and AI Reporting Tools"
format:
  html:
    toc: true
...
1.  **Get the Data:**
    ...
    -   The dataset for this assignment is a CSV file of Data Analyst job postings: [data_analyst_postings_sample.csv](https://github.com/the-graph-courses/aiw_2026_t2_materials/blob/main/week_03_workshop/data/data_analyst_postings_sample.csv){target="_blank"}. There is a download icon at the top right of the file
...
3.  **Prompt ChatGPT:**
    ...
    Please help me create the required visuals and concise report content.

    Before making plots:
    1. Inspect the column names and a few rows.
    2. Clean "Minimum Years Experience" so numeric values can be plotted. Treat NA or non-numeric text as missing.
    3. Standardize "Data Languages" categories to R, Python, Both, and Neither.
    ...
    3. A brief interpretation of each plot, noting the limitations of the small sample size.
    4. A brief introduction describing the data and project.

    Do not write the personal reflection. I will write that myself.
    ```
