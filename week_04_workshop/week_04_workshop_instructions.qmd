...
1.  **Create Your Botpress Account:**
    ...
    -   You may be asked what is your main use case. You can select "Other" and say anything random.

        ![](images/main_use_case.jpg){width="500"}

    -   If asked "How do you want to build?", select Botpress Studio

        ![](images/how_to_build.jpg){width="331"}

    -   You will then see a "What should your bot do" screen that tries to walk you through the setup process. This is not needed.Click skip setup at the top right.

        ![](images/skip_setup.jpg){width="536"}

    -   Next, click on the Home icon at the top left to view the home page for the bot instructions.

        ![](images/home_button.jpg){width="198"}
...
-  Sunday, June 28, 5pm GMT
-  Wednesday, July 1, 3pm GMT
...
3.  **Get Embedding Code:**
    ...
    ![](images/customize_bot_appearance.jpg){width="343"}
