...
Our Week 5 workshop (the second-to-last session) will include optional time for work-in-progress presentations and feedback on your final project. Try to make sure you have at least a draft of the presentation by then.

# Presentation Dates

The final presentation will be on either **Sunday, June 28, 5pm GMT** or **Wednesday, July 1, 3pm GMT**. You will be expected to present in your corresponding class time, which you have been attending. If you need to switch, please let us know with at least one week's notice.
...
5.  **Leave a comment on the course page** if your project has a URL (for example, a live website, app, or hosted tool). Post the link in the comment box on the final project page so classmates and instructors can find it after your presentation.
